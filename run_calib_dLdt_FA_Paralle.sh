...
cd $curdir
path_home="/home/ruitang/OGGM-Ruitang/Results/Test_KS_1T_24Jun/RGI_17.15808_PBS_Test01"
...
if [ $step == 1 ]; then
    ...
    sed -i "s:^option_ind_calving_k.*$:$str_option_ind_calving_k:g" run_calibration_FA_Rt_New_Paralle.py
    str_option_merge_calving_k="option_merge_calving_k = False"
    sed -i "s:^option_merge_calving_k.*$:$str_option_merge_calving_k:g" run_calibration_FA_Rt_New_Paralle.py
    str_option_update_mb_data="option_update_mb_data = False"
    sed -i "s:^option_update_mb_data.*$:$str_option_update_mb_data:g" run_calibration_FA_Rt_New_Paralle.py
    python -u run_calibration_FA_Rt_New_Paralle.py
    #python -u run_calibration_FA_Rt_New_Paralle.py 2>&1 | tee "$path_log2" > /dev/null
    ...
    sed -i "s:^option_update_mb_data.*$:$str_option_update_mb_data:g" run_calibration_FA_Rt_New_Paralle.py
    python -u run_calibration_FA_Rt_New_Paralle.py 
    #python -u run_calibration_FA_Rt_New_Paralle.py 2>&1 | tee "$path_log3" > /dev/null
    ...
    sed -i "/include_calving/c\include_calving = True" pygem_input.py
    str_option_ind_calving_k="option_ind_calving_k = True"
    sed -i "s:^option_ind_calving_k.*$:$str_option_ind_calving_k:g" run_calibration_FA_Rt_New_FA2_Paralle.py
    str_option_merge_calving_k="option_merge_calving_k = False"
    sed -i "s:^option_merge_calving_k.*$:$str_option_merge_calving_k:g" run_calibration_FA_Rt_New_FA2_Paralle.py
    str_option_update_mb_data="option_update_mb_data = False"
    sed -i "s:^option_update_mb_data.*$:$str_option_update_mb_data:g" run_calibration_FA_Rt_New_FA2_Paralle.py
    python -u run_calibration_FA_Rt_New_FA2_Paralle.py
    #python -u run_calibration_FA_Rt_New_FA2_Paralle.py 2>&1 | tee "$path_log6_2" > /dev/null
elif [ $step == 6-3 ]; then
    echo "Step 6-2: Run the calibration for FA (individual calibration) after MCMC calibration"
    sed -i "/include_calving/c\include_calving = True" pygem_input.py
    str_option_ind_calving_k="option_ind_calving_k = False"
    ...
    sed -i "s:^option_update_mb_data.*$:$str_option_update_mb_data:g" run_calibration_FA_Rt_New_FA2_Paralle.py
    #python -u run_calibration_FA_Rt_New_FA2_Paralle.py
    python -u run_calibration_FA_Rt_New_FA2_Paralle.py 2>&1 | tee "$path_log6_3" > /dev/null
