...
cd $curdir
path_home="/home/ruitang/OGGM-Ruitang/Results/Test_KS_1T_24Jun/RGI_17.15808_Test06"
...
if [ $step == 1 ]; then
    ...
    sed -i "s:^option_ind_calving_k.*$:$str_option_ind_calving_k:g" run_calibration_FA_Rt_New_dLdt_and_FA.py
    str_option_merge_calving_k="option_merge_calving_k = False"
    sed -i "s:^option_merge_calving_k.*$:$str_option_merge_calving_k:g" run_calibration_FA_Rt_New_dLdt_and_FA.py
    str_option_update_mb_data="option_update_mb_data = False"
    sed -i "s:^option_update_mb_data.*$:$str_option_update_mb_data:g" run_calibration_FA_Rt_New_dLdt_and_FA.py
    #python -u run_calibration_FA_Rt_New_dLdt_and_FA.py
    python -u run_calibration_FA_Rt_New_dLdt_and_FA.py 2>&1 | tee "$path_log2" > /dev/null
