...
# It's a copy of the run_calibration_AMIS_MB_FA_20002010.py, but calving law in the find_inversion_from_any_mb is SERMeQ
# Built-in libraries
import argparse
import collections
import copy
...
from oggm.core.inversion_RT_New import find_inversion_calving_from_any_mb, fa_sermeq_speed_law_inv
...
#%% ----- the path of output -----
output_fp = pygem_prms.main_directory + '/Calibration_AMIS_MB_FA_20002010_N1000_Th20_SERMeQ/'
            ...
            if invert_standard:
                ...
                try:
                    ...
                    out_calving = find_inversion_calving_from_any_mb(gdir, mb_model= mbmod_inv, mb_years=mb_years,
                                                                    glen_a=cfg.PARAMS['glen_a']*glen_a_multiplier, fs=fs,calving_law_inv = fa_sermeq_speed_law_inv,
