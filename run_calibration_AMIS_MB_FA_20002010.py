...
# It's a copy of the run_calibration_AMIS_MB_FA_New01.py, but the calibration dataset is the 2000-2010 dLdt + 10-year average MB_climate (2000-2010)
...
#%% ----- the path of output -----
output_fp = pygem_prms.main_directory + '/Calibration_AMIS_MB_FA_20002010_N20_New_Th5_Testsingle/'
