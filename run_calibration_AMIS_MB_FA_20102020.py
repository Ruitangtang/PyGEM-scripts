...
# It's a copy of the run_calibration_AMIS_MB_FA_New01.py, but the calibration dataset is the 2010-2020 dLdt + 10-year average MB_climate (2010-2020)
...
#%% ----- the path of output -----
output_fp = pygem_prms.main_directory + '/Calibration_AMIS_MB_FA_20102020_N200/'
