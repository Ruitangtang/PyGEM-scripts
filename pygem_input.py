...
main_directory = '/home/ruitang/OGGM-Ruitang/Results/Test_KS_3T_30Jan/Output/'      # file path hack if data is in different location from code
# Output directory
...
calving_k = 1.5 #150e3                     # frontal ablation calibration parameters, tau0 [KPA/100]
