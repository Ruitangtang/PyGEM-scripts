...
# It's a copy of the run_calibration_AMIS_MB_FA_20002010.py, only changes for the path and name for 
# (frontalablation_fp,frontalablation_fn,frontalablation_annual_fp,frontalablation_annual_fn,hugonnet_fp,hugonnet_fn,lengthchange_annual_fp,lengthchange_annual_fn)
# but will test for single glacier in the region 7, svalbard
...
def main():
    ...
    frontalablation_fn = 'frontal_ablation_obs_20002010_test.csv'
    ...
    frontalablation_annual_fn = ''  # Assign the provided value
    ...
    hugonnet_fn = 'mass_balance_obs_20002010_test.csv'
    ...
    lengthchange_annual_fn = 'lengthchange_annual_rgi_region01_7_20002020_test.csv'
    # output data
