...
do
    ...
    python -u run_calibration_AMIS_SERMeQ.py \
        -rgi_region01 07 \
        -ref_startyear 2000 \
        -ref_endyear 2019 \
...
# python -u run_calibration_AMIS_SERMeQ.py -rgi_region01 07 -ref_startyear 2000 -ref_endyear 2019 -frontalablation_fn "frontal_ablation_obs_20002010_task${task_id}.csv" -hugonnet_fn "mass_balance_obs_20002010_task${task_id}.csv" -lengthchange_annual_fn "lengthchange_annual_rgi_region01_7_20002020_task${task_id}.csv" -store_monthly_step -Visualize_Index -v -debug
# Example command to run single glaciers with specific parameters: ONELINE
#  python -u run_calibration_AMIS_SERMeQ.py -rgi_region01 07 -rgi_glac_number '7.01506' -ref_startyear 2000 -ref_endyear 2019 -frontalablation_fn "frontal_ablation_obs_20002010.csv" -hugonnet_fn "mass_balance_obs_20002010.csv" -lengthchange_annual_fn "lengthchange_annual_rgi_region01_7_20002020.csv" -store_monthly_step -Visualize_Index -v -debug
