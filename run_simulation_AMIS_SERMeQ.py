...
# Default climate data is ERA5; cmip6 data can be specified by providing a filename to the argument: --- IGNORE ---
# Revised by Ruitang Yang on 14 Oct 2024; modified based on run_simulation.py, with the following changes:
...
# Function to create xarray dataset for binned statistics
...
# Function to run the simulation for a single glacier
