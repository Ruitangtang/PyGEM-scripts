...
# Revised by Ruitang Yang on 14 Oct 2024
                            ...
                            if gdir.is_tidewater:
                                ...
                                try:
                                    ...
                                    for n in np.arange(calving_m3_month.shape[0]):
                                        ...
                                        #TODO Check the length/length change calculateion
                                        ev_model.mb_model.glac_length_change[n] = length_change_m_monthly[n]
...
#                            mb_em_sims.append(mb_em_mwea)
            ...
            #                     plt.show()
                        ...
                        if debug:
                            print('mass loss (mass balance total)[Gt]:', mbmod.glac_wide_massbaltotal.sum() / 1e9)
                            print('the glacier wide frontalablation is :',mbmod.glac_wide_frontalablation)
