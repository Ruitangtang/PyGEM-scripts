...
# It's a copy of the run_calibration_AMIS_MB_FA_New01.py, but the calibration dataset is the 2000-2020 dLdt + 10-year average MB_climate (2010-2020)
...
#%% ----- the path of output -----
output_fp = pygem_prms.main_directory + '/Calibration_AMIS_MB_FA_20002020_N200/'
...
#                output_df_all.loc[nglac, 'thick_measured_yn'] = fa_glac_data_reg.loc[fa_idx, 'thick_measured_yn']
            ...
            for nglac in np.arange(main_glac_rgi.shape[0]):
                ...
                for j in range(max_iterations): #TODO DO THE APATED CALIBRATION HERE
                    ...
                    predicted = lengthchange_dLdt_MB_model_array_annual_array
                    observations_sbst_masked = lengthchange_dLdt_annual_CMB_obs_ind_array
                    r_cov = lengthchange_dLdt_annual_CMB_obs_ind_2_array
